...
TIMES="10"
CHATID="6127773468"
KEY="7120624743:7120624743:AAHvZ4150ZVRklpACHHkcC7Z2rhtOUx28wo"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SCRIPT VPIINSTORE              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
# Valid Script
...
data_ip="https://raw.githubusercontent.com/fadilismee/regip/main/izin"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[2;32mWhatsApp\033[0m wa.me/6285939371788"
	echo -e "      \033[2;32mTelegram\033[0m t.me/BjhonStore"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/fadilismee/regip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/fadilismee/regip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/fadilismee/regip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/fadilismee/scpremium/main/"
start=$(date +%s)
secs_to_human() {
...
echo "BJHONSTORE TUNNELING" > /etc/xray/username
echo ""
elif [[ $host == "2" ]]; then
wget ${REPO}Fls/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
echo "BJHOSTORE TUNNELING" > /etc/xray/username
clear
else
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/fadilismee/regip/main/izin | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/fadilismee/regip/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/BjhonStore"},{"text":"Contack","url":"https://wa.me/6285939371788"}]]}'
...
wget raw.githubusercontent.com/fadilismee/scpremium/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd
apt install git -y
git clone https://github.com/fadilismee/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/fadilismee/scpremium/main/Enc/encrypt" ; chmod +x /usr/bin/enc
7z x -pmasukinpw menu.zip
chmod +x menu/*
enc menu/*
...
wget https://raw.githubusercontent.com/fadilismee/scpremium/main/Cfg/m-noobz 
